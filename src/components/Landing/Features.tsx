...
export default function Features() {
  const items = [
    ...
    {
      title: "MJ IA",
      desc: "Un maître du jeu qui t’aide à clarifier, choisir, persister, et rebondir.",
      icon: "🧙",
    },
    {
      title: "Inventaires & rituels",
      ...
      <div className="flex items-end justify-between gap-4">
        <div>
          ...
          <p className="mt-3 text-white/70 max-w-2xl">
            RPG Renaissance transforme ta progression personnelle en aventure:
            claire, épique, mesurable.
          </p>
        </div>
      </div>
