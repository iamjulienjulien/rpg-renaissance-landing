...
export default function Sigils() {
  return (
    <div aria-hidden className="pointer-events-none fixed inset-0 -z-10">
      <motion.div
        className="absolute -left-15 top-30 opacity-35 blur-[0.5px]"
        animate={{ rotate: 360 }}
      ...
      <motion.div
        className="absolute -right-22.5 top-10 opacity-25 blur-[0.5px]"
        animate={{ rotate: -360 }}
      ...
      <motion.div
        className="absolute left-[20%] -bottom-35 opacity-20 blur-[0.5px]"
        animate={{ rotate: 360 }}
